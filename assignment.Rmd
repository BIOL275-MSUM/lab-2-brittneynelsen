...
First, I combine the values into a vector using the `c()` function, assign it to a variable named `k`, and print `k`
...
And finally, I can see the 95% confidence interval ranges from a minimum of 4.203409 to a maximum of 5.430591
